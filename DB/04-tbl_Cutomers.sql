...
/****** Object:  Table [dbo].[tbl_Cutomers]    Script Date: 2/3/2017 2:05:40 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[tbl_Cutomers]  WITH CHECK ADD  CONSTRAINT [FK_tbl_Cutomers_tbl_CustomerGroup] FOREIGN KEY([CustomerGroupCode])
REFERENCES [dbo].[tbl_CustomerGroup] ([CustomerGroupCode])
GO
